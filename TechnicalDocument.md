...
## 5.3 The function driving the simulation
...
## 5.4 The visualization functions
...
## 5.5 The main() function driving the deployed Python package

For detail about setting up the environment for an experimenter as well as how to execute the Python package please refer to README.md
